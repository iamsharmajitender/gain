...
- For detailed security review guidance, see `.cursor/references/security-checklist.md`
- For performance review checks, see `.cursor/references/performance-checklist.md`
