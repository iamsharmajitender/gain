...
Machine callers need workload identity with the same rigor as humans: scoped service accounts, not shared API keys with god-mode access. For the dual-principal primer (user vs agent), see [Agent Identity: Who Is Asking vs Which Software Is Acting](/insights/agent-identity).
</Details>
