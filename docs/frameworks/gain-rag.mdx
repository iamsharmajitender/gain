...
flowchart LR
    ...
    style validate fill:#f8fafc,stroke:#cbd5e1,color:#1e293b,stroke-width:1px
    style synthesize fill:#f8fafc,stroke:#cbd5e1,color:#1e293b,stroke-width:1px
...
| Resource | Use when |
| --- | --- |
| [RAG Blueprint](/blueprints/rag-blueprint) | Reference design: mode, scope, pack |
| [RAG playbooks](/playbooks/rag) | Implement prefetch vs tool retrieve |
| [Eval Plane ③ Context](/playbooks/evaluation/plane-context) | Recall, scope leaks, abstention |
| [Runtime](/playbooks/governance/runtime) | PEP on the retrieve action |
