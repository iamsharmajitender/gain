...
| Resource | Use when |
| --- | --- |
| [LLM Blueprint](/blueprints/llm-blueprint) | Capability matrix, task routing, canary |
| [LLM playbooks](/playbooks/llm) | Implement gateway model routing |
| [Agents Blueprint](/blueprints/agents-blueprint) | Where `model_profile` is pinned on the route |
