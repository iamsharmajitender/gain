...
| Asset | Role |
| --- | --- |
| [G.A.I.N core](/frameworks) | Operating model spine |
| [How to model LLM gateway](/blueprints/llm-gateway) | Platform ingress, registry, shared ops (blueprint) |
| [How to Integrate LLMs in Production](/playbooks/llm-integration-guide) | How to build |
