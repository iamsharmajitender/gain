...
For when MCP earns its cost versus governed domain APIs for business agents, see [Is MCP Really Necessary for Business Agents in Large Regulated Enterprises?](/insights/mcp-for-enterprise-business-agents).
...
| Resource | Use when |
| --- | --- |
| [MCP Blueprint](/blueprints/mcp-blueprint) | Reference design: transport, gateway, server registry |
| [Agents Blueprint](/blueprints/agents-blueprint) | Versioned manifest, pinned tools, schemas only |
| [MCP playbooks](/playbooks/mcp) | MCP as transport |
| [Manifest registry](/playbooks/agents/manifests/manifest-registry) | Tool contract and lifecycle |
| [Eval Plane ⑤ Tool](/playbooks/evaluation/plane-tool) | Schema and allowlist eval |
| [Runtime](/playbooks/governance/runtime) | PEP maps `pdp_action` |
