...
:::tip
**Reading order:** Start with [G.A.I.N AIOM](/frameworks/gain-aiom) for plane ownership; domain frameworks (LLM, RAG, Agents, …) apply G · A · I · N to specific capabilities.
:::
