...
| Resource | Use when |
| --- | --- |
| [Eval Blueprint](/blueprints/evaluation-blueprint) | Sources, scorers, modes, eight planes |
| [Evaluation playbooks](/playbooks/evaluation) | Golden sets, scorers, per-plane gates |
