...
**Two views, one domain.** Executives need the layer model; platform teams need the control path. Same boundary, different questions.

| View | Question | Audience |
| --- | --- | --- |
| **Layer model** | How do Responsible, Regulatory, Risk, and Governance relate? | Exec, risk, compliance, architects |
| **Control path** | How does one use case stay governed from approval to production evidence? | Platform, security, SRE, product |
