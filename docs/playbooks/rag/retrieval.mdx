...
| `prompt_id` | Query formulation or synthesis. The model does not pick the corpus. Pack shape: [Prompt artifact](/playbooks/agents/intent-router/route-contract-reference#prompt-artifact) |
