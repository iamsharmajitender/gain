---
slug: /agents/intent-router/routing-eval-ci
...
[Blueprint](/blueprints/agents-blueprint) · [← Wire app](/playbooks/agents/intent-router/wire-agentic-app) · **Eval CI**

Build the golden set **in parallel** with the route table and classifier, not after launch. Scoring aligns with [Eval Plane ①: Input](/playbooks/evaluation/plane-input).
...
**[Eval Plane ①: Input →](/playbooks/evaluation/plane-input)** · **[Agents Blueprint →](/blueprints/agents-blueprint)**
