...
| --- | --- | --- |
| `plan` | Pattern 1/3 next-step, Pattern 2 stage with `llm_role: plan` | Reasoning tier |
| `synthesize` | User-facing answer, Pattern 0 completion | Chat or reasoning per route |
