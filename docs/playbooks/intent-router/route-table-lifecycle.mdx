...
[Blueprint](/blueprints/intent-router-blueprint) · **Route table** · [Layered classifier →](/playbooks/intent-router/layered-classifier)
...
See [Routing eval CI](/playbooks/intent-router/routing-eval-ci) for gates.
