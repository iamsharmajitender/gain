...
The Input plane is where requests enter: parsing, normalization, intent classification, and first-line safety filters. Failures here poison every downstream plane. See [What Is an Intent Router](/insights/what-is-intent-router) for the architectural role; this plane is where you eval it.
...
- **Intent misroute** — wrong workflow or tool family selected ([What Is an Intent Router](/insights/what-is-intent-router))
