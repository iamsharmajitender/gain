...
| **[Domain](/playbooks/pgar-runtime/domain/manifest-registry)** | Manifest registry | Tool manifests, lifecycle, RAG retrieval as governed actions |
...
4. **[Domain](/playbooks/pgar-runtime/domain/manifest-registry)** (3 playbooks): pick tools, manifests, and/or RAG for your agent surface
...
| Playbook | One-line purpose |
| --- | --- |
| [Manifest registry](/playbooks/pgar-runtime/domain/manifest-registry) | Manifest contract, PEP gating per tool |
...
| **AI platform** | [PEP enforcement](/playbooks/pgar-runtime/foundation/pep-enforcement), [Agentic app](/playbooks/pgar-runtime/boundary/agentic-app) | [Manifest registry](/playbooks/pgar-runtime/domain/manifest-registry), [Manifest lifecycle](/playbooks/pgar-runtime/domain/manifest-lifecycle) |
