...
Foundation playbooks define **how PGAR works before you wire a specific agent surface**. They cover contracts, custody, enforcement, verdicts, attestation, and audit. Read them before [boundary](/playbooks/pgar-runtime/boundary) and [domain](/playbooks/pgar-runtime/domain/manifest-registry) playbooks.
...
Then [boundary playbooks](/playbooks/pgar-runtime/boundary) (where each control sits in the request path) and [domain playbooks](/playbooks/pgar-runtime/domain/manifest-registry) (tools, manifests, RAG).
