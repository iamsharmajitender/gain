...
[Blueprint](/blueprints/pgar-blueprint) · [← PEP + PDP](/playbooks/pgar-runtime/boundary/pep-pdp) · **Downstream** · [Manifest registry →](/playbooks/pgar-runtime/domain/manifest-registry)
...
<Details summary="Downstream return path (pseudo-code)">
...
See: [Audit & replay](/playbooks/pgar-runtime/foundation/audit-and-replay) · [Domain: manifest registry](/playbooks/pgar-runtime/domain/manifest-registry) · [Boundary overview](/playbooks/pgar-runtime/boundary)
