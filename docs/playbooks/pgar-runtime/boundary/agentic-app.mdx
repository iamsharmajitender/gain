...
2. Load or pin [tool manifest](/playbooks/pgar-runtime/domain/manifest-lifecycle) scoped by the [intent router](/insights/what-is-intent-router) route contract (`manifest_version` on session)
