---
slug: /governance/runtime/assurance/adversarial-testing
...
[Blueprint](/blueprints/governance/runtime) · [← Policy scenarios](/playbooks/governance/runtime/assurance/policy-test-scenarios) · **Adversarial** · [Further reading →](/playbooks/governance/runtime/further-reading)
...
[Eval plane Tool](/playbooks/evaluation/plane-tool) and [Action](/playbooks/evaluation/plane-action) score whether adversarial cases failed in production traces. PGAR scenarios prevent shipping the bypass.

## Trace fields

`adversarial_class`, `proposal`, `verdict`, `bypass_attempted`, `pep_blocked`

See: [Policy test scenarios](/playbooks/governance/runtime/assurance/policy-test-scenarios) · [PEP enforcement](/playbooks/governance/runtime/foundation/pep-enforcement)
