---
slug: /governance/runtime/foundation/pep-enforcement
...
[Blueprint](/blueprints/governance/runtime) · [← Token & session](/playbooks/governance/runtime/foundation/token-and-session-boundary) · **PEP enforcement** · [PDP surfaces →](/playbooks/governance/runtime/foundation/pdp-policy-surfaces)
...
2. **Ask PDP:** map to [SARAC contract](/playbooks/governance/runtime/foundation/policy-contracts); call PDP
...
See: [Boundary: PEP + PDP](/playbooks/governance/runtime/boundary/pep-pdp) · [Audit & replay](/playbooks/governance/runtime/foundation/audit-and-replay)
