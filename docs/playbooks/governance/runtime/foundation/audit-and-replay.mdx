---
slug: /governance/runtime/foundation/audit-and-replay
title: "Audit & Replay"
...
[Blueprint](/blueprints/governance/runtime) · [← Step-up](/playbooks/governance/runtime/foundation/step-up-and-attestation) · **Audit & replay** · [Policy scenarios →](/playbooks/governance/runtime/assurance/policy-test-scenarios)
...
<Details summary="Minimum audit record (JSON)">
...
See: [PEP enforcement](/playbooks/governance/runtime/foundation/pep-enforcement) · [Eval plane Action](/playbooks/evaluation/plane-action)
