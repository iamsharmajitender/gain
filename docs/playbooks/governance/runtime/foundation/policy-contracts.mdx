---
slug: /governance/runtime/foundation/policy-contracts
...
[Blueprint](/blueprints/governance/runtime) · [← Foundation overview](/playbooks/governance/runtime/foundation) · **Policy contracts** · [Token & session →](/playbooks/governance/runtime/foundation/token-and-session-boundary)
...
<Details summary="Wire initiation SARAC (JSON)">
...
<Details summary="RAG retrieval SARAC (JSON)">
...
See [RAG retrieval](/playbooks/rag/retrieval).
...
<Details summary="SARAC automated checks (pseudo-code)">
...
See: [PEP Enforcement](/playbooks/governance/runtime/foundation/pep-enforcement) · [Governance Blueprint](/blueprints/governance/runtime)
