---
slug: /governance/runtime/boundary/llm-proposal
...
[Blueprint](/blueprints/governance/runtime) · [← Agentic app](/playbooks/governance/runtime/boundary/agentic-app) · **LLM proposal** · [PEP + PDP →](/playbooks/governance/runtime/boundary/pep-pdp)
...
See [Manifest registry](/playbooks/agents/manifests/manifest-registry).
...
See: [Token & session boundary](/playbooks/governance/runtime/foundation/token-and-session-boundary) · [Boundary overview](/playbooks/governance/runtime/boundary)
