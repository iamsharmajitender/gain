...
[Blueprint](/blueprints/router-blueprint) · [← Route table](/playbooks/router/intent-router/route-table-lifecycle) · **Classifier** · [Wire agentic app →](/playbooks/router/intent-router/wire-agentic-app)
...
**[Wire agentic app →](/playbooks/router/intent-router/wire-agentic-app)**
