...
- Pairwise metrics on matched traffic (see [LLM-as-Judge](/playbooks/evaluation/llm-as-judge) pairwise mode)
...
Fits the production eval loop in the [Eval Blueprint](/blueprints/evaluation-blueprint):

<Details summary="Production eval loop (pseudo-code)">
...
- [Synthetic Generation](/playbooks/evaluation/synthetic-generation) — fill coverage gaps
- [Golden Datasets](/playbooks/evaluation/golden-datasets) — where promoted cases land
