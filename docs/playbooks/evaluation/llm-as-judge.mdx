...
<Details summary="Rubric prompt template (pseudo-code)">
...
Plane-specific dimensions live in each [plane playbook](/blueprints/evaluation-blueprint).
...
1. Human scores calibration split ([Human Review](/playbooks/evaluation/human-review))
...
<Details summary="Gate aggregation (pseudo-code)">
...
- [Human Review](/playbooks/evaluation/human-review) — ground truth
- [Golden Datasets](/playbooks/evaluation/golden-datasets) — what the judge runs on
