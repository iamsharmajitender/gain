...
sidebar_label: "Synthetic Generation"
...
See each [plane playbook](/blueprints/evaluation-blueprint) for gate criteria.
...
- [Golden Datasets](/playbooks/evaluation/golden-datasets) — schema and layers
- [Online & Dynamic Eval](/playbooks/evaluation/online-dynamic) — prod feedback
