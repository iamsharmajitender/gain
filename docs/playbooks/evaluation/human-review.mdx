...
1. Humans score **calibration split** (see [Golden Datasets](/playbooks/evaluation/golden-datasets))
...
See [Online & Dynamic Eval](/playbooks/evaluation/online-dynamic) for sampling rates, shadow scoring, and drift alerts.
...
- [LLM-as-Judge](/playbooks/evaluation/llm-as-judge) — scale what humans define
- [Golden Datasets](/playbooks/evaluation/golden-datasets) — case library design
- Plane playbooks: [Context](/playbooks/evaluation/plane-context) · [Action](/playbooks/evaluation/plane-action)
