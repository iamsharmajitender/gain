...
[Blueprint](/blueprints/evaluation-blueprint) · [← Memory](/playbooks/evaluation/plane-memory) · **Action** · [Outcome →](/playbooks/evaluation/plane-outcome)
...
See: [Governance Blueprint](/blueprints/governance/runtime) · [RAG retrieval](/playbooks/rag/retrieval)
