...
[Blueprint](/blueprints/evaluation-blueprint) · [← Data](/playbooks/evaluation/plane-data) · **Context** · [Reasoning →](/playbooks/evaluation/plane-reasoning)
...
This is not the Data plane. Data owns freshness, lineage, ACL at ingest, and index correctness. Context owns whether *this user*, *this question*, got the right chunks in the pack. A scope leak can be a Data indexing bug or a Context filter bug: separate evals tell you which. Stale corpus is Data; wrong recall@k on a fresh index is Context. See [Data plane eval ←](/playbooks/evaluation/plane-data) and [G.A.I.N RAG](/frameworks/gain-rag).
...
See also: [G.A.I.N RAG](/frameworks/gain-rag) · [RAG retrieval](/playbooks/rag/retrieval)
