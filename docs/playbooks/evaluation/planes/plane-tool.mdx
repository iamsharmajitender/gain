...
[Blueprint](/blueprints/evaluation-blueprint) · [← Reasoning](/playbooks/evaluation/plane-reasoning) · **Tool** · [Memory →](/playbooks/evaluation/plane-memory)
...
See: [Manifest registry](/playbooks/agents/manifests/manifest-registry) · [Governance Blueprint](/blueprints/governance/runtime) · [RAG retrieval](/playbooks/rag/retrieval)
