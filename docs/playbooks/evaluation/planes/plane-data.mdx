...
[Blueprint](/blueprints/evaluation-blueprint) · [← Input](/playbooks/evaluation/plane-input) · **Data** · [Context →](/playbooks/evaluation/plane-context)
...
| --- | --- |
| Source ingestion, normalization, chunking | Query parsing, intent routing ([Input](/playbooks/evaluation/plane-input)) |
| Catalog / schema of documents and APIs | Retrieve, rank, pack for one call ([Context](/playbooks/evaluation/plane-context)) |
| ACL at ingest and index-time entitlement | Whether the model reasoned correctly ([Reasoning](/playbooks/evaluation/plane-reasoning)) |
| Index builds, embeddings, tombstones | Tool calls and side effects ([Tool](/playbooks/evaluation/plane-tool), [Action](/playbooks/evaluation/plane-action)) |
| Freshness SLAs, reindex jobs, deletion propagation | Whether the user got a useful answer ([Outcome](/playbooks/evaluation/plane-outcome)) |
...
Eval gates should be able to read **data green, context red** (or the reverse). See [Context plane eval →](/playbooks/evaluation/plane-context) and [G.A.I.N RAG](/frameworks/gain-rag).
...
Tag production incidents with these classes. Promote each to a golden case within a week ([Golden Datasets](/playbooks/evaluation/golden-datasets)).
...
<Details summary="Data golden case schema (JSON)">
...
<Details summary="Data plane automated checks (Python)">
...
- [Context plane eval](/playbooks/evaluation/plane-context) — query-time retrieval (paired with this page)
- [Golden Datasets](/playbooks/evaluation/golden-datasets) — how to structure and version Data cases
- [G.A.I.N RAG](/frameworks/gain-rag) — why the store is not the architecture
- [Further reading (external)](/playbooks/evaluation/further-reading) — Evidently RAG guide (corpus vs retrieval split)

---

[Blueprint](/blueprints/evaluation-blueprint) · [Context →](/playbooks/evaluation/plane-context)
