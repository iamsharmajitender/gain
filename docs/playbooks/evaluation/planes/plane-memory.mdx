...
[Blueprint](/blueprints/evaluation-blueprint) · [← Tool](/playbooks/evaluation/plane-tool) · **Memory** · [Action →](/playbooks/evaluation/plane-action)

The Memory plane carries state across turns: conversation history, user prefs, workflow state. Silent leakage across sessions is a compliance incident waiting to happen. How to build the store: [Memory](/playbooks/agents/orchestration/memory).
