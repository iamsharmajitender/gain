...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">LLM Gateway</h1>
...
<Details className="gain-accordion" summary="Model abstraction layer">
  ...
  See [AI Control Plane](/blueprints/control-plane) for full platform context.
</Details>
...
<Details className="gain-accordion" summary="RAG and tool hooks">
  ...
  - **RAG:** delegate to Context Engine before generation: [RAG Architecture](/blueprints/rag-architecture)
  - **Agents:** hand off to agent runtime: [Agent Flow Model](/blueprints/agent-flow-model)
...
- [AI Control Plane](/blueprints/control-plane): hosting context for all platform components
- [Context Engine](/blueprints/context-engine): when LLM calls require grounded context
- [AI Runtime Plane](/blueprints/runtime-plane): inference endpoints and GPU pools
- [RAG Architecture](/blueprints/rag-architecture): retrieval-before-generation path
