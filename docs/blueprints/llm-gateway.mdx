---
slug: llm-gateway
title: How to Model LLM Gateway
sidebar_label: How to Model LLM Gateway
hide_title: true
tags:
...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">How to Model LLM Gateway</h1>
...
<Details className="gain-accordion" summary="RAG and tool hooks">
  ...
  - **RAG:** delegate to Context Engine before generation: [How to Model RAG Architecture](/blueprints/rag-architecture)
  - **Agents:** hand off to agent runtime: [How to Model Agent Flow](/blueprints/agent-flow-model)
...
- [How to Model RAG Architecture](/blueprints/rag-architecture): retrieval-before-generation path
