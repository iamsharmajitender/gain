---
title: AI Runtime Plane
sidebar_label: AI Runtime Plane
hide_title: true
---
...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">AI Runtime Plane</h1>
...
- [AI Control Plane](/blueprints/control-plane): primary consumer of runtime endpoints
- [Context Engine](/blueprints/context-engine): vector query and embedding calls
- [Data / Knowledge Plane](/blueprints/data-knowledge-plane): index population and catalog
- [LLM Gateway](/blueprints/llm-gateway): platform-side abstraction over inference endpoints
