...
sidebar_label: How to Model Context Engine
hide_title: true
tags:
  - ai-intelligence
  - rag
...
<Details className="gain-accordion" summary="Retrieval orchestrator">
  ...
  See [How to Model RAG Architecture](/blueprints/rag-architecture) for indexing and retrieval layer detail.
</Details>
...
- [How to Model RAG Architecture](/blueprints/rag-architecture): indexing and retrieval layers in depth
