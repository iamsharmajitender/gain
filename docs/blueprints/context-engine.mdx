...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">Context Engine</h1>
...
<Details className="gain-accordion" summary="Retrieval orchestrator">
  ...
  See [RAG Architecture](/blueprints/rag-architecture) for indexing and retrieval layer detail.
</Details>
...
<Details className="gain-accordion" summary="Governance filter">
  ...
  Works with [Policy Engine](/blueprints/control-plane): policy decides *if* retrieval may run;
...
- [AI Control Plane](/blueprints/control-plane): gateway, policy, and capability hosting
- [Data / Knowledge Plane](/blueprints/data-knowledge-plane): upstream pipelines and catalog
- [RAG Architecture](/blueprints/rag-architecture): indexing and retrieval layers in depth
