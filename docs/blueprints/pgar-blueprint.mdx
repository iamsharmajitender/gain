...
| --- | --- | --- |
| **Manifest registry** | API calls, workflows | [Manifest registry](/playbooks/pgar-runtime/domain/manifest-registry) · [Manifest lifecycle](/playbooks/pgar-runtime/domain/manifest-lifecycle) · [Worked example](/playbooks/pgar-runtime/domain/manifest-registry#worked-example-one-proposal) |
...
4. [Manifest registry](/playbooks/pgar-runtime/domain/manifest-registry) and [manifest lifecycle](/playbooks/pgar-runtime/domain/manifest-lifecycle) for your agent's tool contract
...
**Domain playbooks**
- [Manifest registry](/playbooks/pgar-runtime/domain/manifest-registry) · [Manifest lifecycle](/playbooks/pgar-runtime/domain/manifest-lifecycle) · [RAG retrieval](/playbooks/pgar-runtime/domain/rag-retrieval)
