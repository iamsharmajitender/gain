---
slug: decision-model
title: How to Model the Decision
description: "Structured decision-making patterns: reasoning chains, policy gates, and human-in-the-loop workflows."
date: 2026-01-15
...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">How to Model the Decision</h1>
