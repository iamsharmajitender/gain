...
Deep dive: [The Blueprint Before Training](/insights/before-training-an-llm) — hyperparameter math, 7B parameter walkthrough, context window, and tokenizer steps.
