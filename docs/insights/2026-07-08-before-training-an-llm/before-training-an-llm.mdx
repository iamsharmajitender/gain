...
![Before Training an LLM: From Design Dials to a Frozen Shape](./before-training-an-llm.png)

# Before Training an LLM: From Design Dials to a Frozen Shape
...
Continue the lifecycle: [How LLM Works Under the Hood](/insights/how-llm-works-under-the-hood) (Stages 2-4). Deep dives: [During Training an LLM](/insights/during-training-an-llm), [Aligning an LLM](/insights/aligning-an-llm), [After Training an LLM](/insights/after-training-an-llm).
:::
