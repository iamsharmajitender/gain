  ...
  "rules": [
    {
      ...
      "when": {
        ...
        "subject.emts.excludes": "payments.wire.initiate"
      }
    },
    {
      "decision": "DENY",
    ...
    },
    {
      ...
      "when": {
        ...
        "subject.emts.includes": "payments.lookup"
      }
    },
    {
      "decision": "ALLOW",
      "when": {
        ...
        "subject.emts.includes": "payments.validate",
...
**Implementation series:** [Governance Blueprint](/blueprints/governance/runtime) · [Governance playbooks](/playbooks/governance) · [PGAR with RAG](/insights/retrieval-is-a-governed-action) · [MCP for enterprise business agents](/insights/mcp-for-enterprise-business-agents) · [Agent Identity](/insights/agent-identity)
