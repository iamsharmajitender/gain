...
- **Pin a route contract** at the [intent router](/insights/design-intent-router): agent identity, tool manifest, policy profile, allowed context, execution shape.
...
:::info[Builds on]
[Policy-Governed Agent Runtime](/insights/policy-governed-agent-runtime) · [Design an Intent Router](/insights/design-intent-router) · [Autonomy Blueprint](/blueprints/autonomy-blueprint) · [RAG Is Not a Database](/insights/rag-is-not-a-database) · [G.A.I.N MCP](/frameworks/gain-mcp)
:::
