...
| **Context** | What data and corpora the agent may access | Retrieval scope, entitlements, session claims |
| **Execution policy** | How the workflow may run (one call, fixed stages, open loop) | Workflow / autonomy pattern ([Autonomy Blueprint](/blueprints/autonomy-blueprint)) |
...
:::info[Builds on]
[Policy-Governed Agent Runtime](/insights/policy-governed-agent-runtime) · [Design an Intent Router](/insights/design-intent-router) · [Autonomy Blueprint](/blueprints/autonomy-blueprint) · [RAG Is Not a Database](/insights/rag-is-not-a-database) · [G.A.I.N MCP](/frameworks/gain-mcp) · [Agent Identity](/insights/agent-identity)
:::
