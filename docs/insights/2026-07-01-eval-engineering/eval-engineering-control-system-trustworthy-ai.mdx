...
Same bad answer, different root cause: stale policy in the index is a **Data** failure; the right doc ranked fifth is a **Context** failure. Eval them separately so gates can read "data green, context red." See [Data plane](/playbooks/evaluation/plane-data) and [Context plane](/playbooks/evaluation/plane-context).
:::
...
**Start here:** [Evaluation Blueprint](/blueprints/evaluation-blueprint)

| Guide | Topic |
| --- | --- |
| [Golden Datasets](/playbooks/evaluation/golden-datasets) | Curated cases, versioning, splits |
| [Synthetic Generation](/playbooks/evaluation/synthetic-generation) | Edge & adversarial coverage at scale |
| [Online & Dynamic Eval](/playbooks/evaluation/online-dynamic) | Live sampling, shadow, canary, drift |
| [Human Review](/playbooks/evaluation/human-review) | Manual eval, rubrics, calibration |
| [LLM-as-Judge](/playbooks/evaluation/llm-as-judge) | Scaled scoring, pairwise comparison |
| [① Input](/playbooks/evaluation/plane-input) · [② Data](/playbooks/evaluation/plane-data) · [③ Context](/playbooks/evaluation/plane-context) · [④ Reasoning](/playbooks/evaluation/plane-reasoning) | Ingress & intelligence planes |
| [⑤ Tool](/playbooks/evaluation/plane-tool) · [⑥ Memory](/playbooks/evaluation/plane-memory) · [⑦ Action](/playbooks/evaluation/plane-action) · [⑧ Outcome](/playbooks/evaluation/plane-outcome) | Execution & delivery planes |
| [Further reading (external)](/playbooks/evaluation/further-reading) | Curated third-party articles & tool docs |
