---
slug: api-design
title: How to Architect API Design
description: Contracts, versioning, and integration boundaries that outlive their implementations.
date: 2026-01-15
...
<div className="gain-doc-header">
  <h1 className="gain-doc-title">How to Architect API Design</h1>
...
<Details className="gain-accordion" summary="Security & rate limiting">
  Authenticate at the edge (OAuth2 / OIDC, scoped tokens), authorize per resource, and enforce per-consumer rate limits and quotas. Validate every input against the schema and never trust client-supplied identity.
</Details>
