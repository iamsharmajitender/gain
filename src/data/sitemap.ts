...
export const handbookSections: SitemapSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'Control Plane', href: '/blueprints/control-plane'},
      {label: 'Context Engine', href: '/blueprints/context-engine'},
      {label: 'Data / Knowledge Plane', href: '/blueprints/data-knowledge-plane'},
      {label: 'Runtime Plane', href: '/blueprints/runtime-plane'},
      {label: 'LLM Gateway', href: '/blueprints/llm-gateway'},
      {label: 'RAG Architecture', href: '/blueprints/rag-architecture'},
      {label: 'Agent Flow Model', href: '/blueprints/agent-flow-model'},
      {label: 'G.A.I.N Architecture', href: '/blueprints/gain-architecture'},
      {label: 'Memory Model', href: '/blueprints/memory-model'},
      {label: 'Decision Model', href: '/blueprints/decision-model'},
    ],
  },
  {
    id: 'architecture',
    ...
    links: [
      ...
      {label: 'Governance & Security', href: '/architecture/governance-security'},
    ],
  },
  {
    id: 'playbooks',
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'Strategy & Architecture', href: '/insights/tags/strategy-architecture'},
