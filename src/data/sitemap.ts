...
export const handbookSections: SitemapSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'Eval Blueprint', href: '/blueprints/evaluation-blueprint'},
      {label: 'Agents Blueprint', href: '/blueprints/agents-blueprint'},
      {label: 'LLM Blueprint', href: '/blueprints/llm-blueprint'},
      {label: 'Governance', href: '/blueprints/governance'},
      {label: 'Operating', href: '/blueprints/governance/operating'},
      {label: 'Runtime', href: '/blueprints/governance/runtime'},
      {label: 'Observability Blueprint', href: '/blueprints/observability-blueprint'},
      {label: 'RAG Blueprint', href: '/blueprints/rag-blueprint'},
      {label: 'MCP Blueprint', href: '/blueprints/mcp-blueprint'},
    ],
  },
  {
    id: 'playbooks',
    ...
    links: [
      ...
      {label: 'Evaluation', href: '/playbooks/evaluation'},
      {label: 'Agents', href: '/playbooks/agents'},
      {label: 'Intent router (Plane ①)', href: '/playbooks/agents/intent-router'},
      {label: 'LLM', href: '/playbooks/llm'},
      {label: 'Governance', href: '/playbooks/governance'},
      {label: 'Operating', href: '/playbooks/governance/operating'},
      {label: 'Runtime', href: '/playbooks/governance/runtime'},
      {label: 'RAG', href: '/playbooks/rag'},
      {label: 'MCP', href: '/playbooks/mcp'},
      {label: 'Observability', href: '/playbooks/observability'},
    ],
  },
  {
    id: 'insights',
