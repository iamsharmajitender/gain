...
export const handbookSections: SitemapSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'How to Model an LLM Gateway', href: '/blueprints/llm-gateway'},
      {label: 'How to Model RAG Pipeline Layers', href: '/blueprints/rag-architecture'},
      {label: 'How to Model Agent Execution Flows', href: '/blueprints/agent-flow-model'},
      {label: 'How to Model the Full Enterprise AI Stack', href: '/blueprints/gain-architecture'},
      {label: 'How to Model Agent Memory', href: '/blueprints/memory-model'},
      {label: 'How to Model the Decision', href: '/blueprints/decision-model'},
    ],
  },
  {
    id: 'architecture',
    ...
    href: '/architecture',
    links: [
      {label: 'How to Architect Distributed Systems', href: '/architecture/distributed-systems'},
      {label: 'How to Architect Event-Driven Systems', href: '/architecture/event-driven-systems'},
      {label: 'How to Architect API Design', href: '/architecture/api-design'},
      {label: 'How to Architect LLM Production Patterns', draft: true},
      {label: 'How to Architect Governed Agent Systems', draft: true},
      {label: 'How to Architect Enterprise RAG Systems', draft: true},
      {label: 'How to Architect Hallucination Guardrails', draft: true},
      {label: 'How to Architect AI Observability', draft: true},
      {label: 'How to Architect Policy and Identity Boundaries', draft: true},
      {label: 'How to Architect a Banking AI Assistant', draft: true},
      {label: 'How to Architect Full-Stack AI Foundations', draft: true},
      {label: 'How to Architect for the Next Maturity Level', draft: true},
      {label: 'How to Architect Governed MCP Integration', draft: true},
      {label: 'How to Architect for LLM Cost and Routing', draft: true},
      {label: 'How to Architect RAG Evaluation', draft: true},
    ],
  },
  {
    id: 'playbooks',
    ...
    href: '/playbooks',
    links: [
      {label: 'How to Build Enterprise RAG', href: '/playbooks/build-enterprise-rag'},
      {label: 'How to Build Agentic Systems', href: '/playbooks/agentic-systems-design'},
      {label: 'How to Build AI Observability in Production', href: '/playbooks/ai-observability'},
      {label: 'How to Build Data Pipelines for AI', href: '/playbooks/data-pipelines-for-ai'},
      {label: 'How to Integrate LLMs in Production', href: '/playbooks/llm-integration-guide'},
      {label: 'How to Build Access-Controlled RAG', draft: true},
      {label: 'How to Build a RAG Eval Harness', draft: true},
      {label: 'How to Build a Banking AI Platform', draft: true},
      {label: 'How to Build a Governed MCP Setup', draft: true},
      {label: 'How to Build a Verification Layer', draft: true},
    ],
  },
  {
    id: 'insights',
